                ...
                <table class="min-w-full divide-y divide-gray-200 text-sm text-left">
                    <thead class="bg-gray-50 text-gray-700">
                        <tr>
                            ...
                            <th class="px-4 py-2 border-b font-semibold whitespace-nowrap">Action</th>
                            <th class="px-4 py-2 border-b font-semibold whitespace-nowrap">Subject</th>
                            <th class="px-4 py-2 border-b font-semibold whitespace-nowrap">Description</th>
                    ...
                    <tbody class="divide-y divide-gray-200">
                        ...
                        <tr v-else class="hover:bg-gray-50" v-for="(permission, index) in permissions" :key="index">
                            ...
                            <td class="px-4 py-1 whitespace-nowrap">{{ permission.description }}</td>
